  ...
  return (
    <Fragment>
      ...
      <View style={styles.container_1}>
        <Image
          source={require("../assets/images/housing.png")}
          style={styles.img_1}
        />
      </View>
      <View style={styles.container_2}>
        <Text style={styles.text_1}>
          Find the perfect space in your desired location.
        </Text>
        <Text style={styles.text_2}>
          Explore a big collection of sober living spaces in your desired
          location.
        </Text>
